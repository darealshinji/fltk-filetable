...
#define FILE_ARCHIVE_SVG_DATA \
  ...
  "<path d='m3 28s-1 2.47-1 5.25c0 3.61.62 7.37.62 7.37s2.35 1.95 5.61 3.68c3.97 2.1 8.38 3.43 8.38 3.43l.01-13.86 12.88-13.12s-4.05-1.65-7.84-3.2c-3.37-1.38-6.55-1.67-6.55-1.67s-4.07 2.07-7.24 5.24c-3.38 3.38-4.87 6.88-4.87 6.88zm27-8.25 8.93-9.69s-3.86-1.4-7.51-2.73c-3.29-1.2-6.42-1.33-6.42-1.33s-1.73.72-3.63 2.62l-4.88 4.88 13.51 6.25zm1.5 1.62 16.37 5.63.05 14.96s3.92-3.85 6.44-7.18c1.93-2.54 2.64-5.16 2.64-5.16s1-3.67 1-7.25c0-2.84-1.75-4.87-1.75-4.87s-4.04-2.61-8.92-4.38c-3.54-1.29-6.61-1.91-6.61-1.91s-2.05 1.44-4.32 3.58c-2.79 2.64-4.9 6.58-4.9 6.58zm15.12 7.63s-4.2-2.15-8.65-4.06c-3.97-1.7-7.47-2.69-7.47-2.69s-2.91 2.24-5.72 5.29c-3.16 3.43-6.16 7.08-6.16 7.08s-.38 2.97-.38 6.26c0 4.1.63 8.59.63 8.59s3.28 2.19 7.43 4.39c4.69 2.49 9.7 3.39 9.7 3.39s3.12-2.38 6.12-6.33c2.76-3.63 4.65-7.25 4.65-7.25s.46-3.59.43-7.31c-.04-3.74-.58-7.36-.58-7.36z' fill='none' stroke='#010000' stroke-width='4'/>" \
  ...
  "</linearGradient>" \
  "<path d='m46.62 29s-1.64 3.22-4.28 6.46c-2.67 3.26-6.34 6.54-6.34 6.54v15.25s3.12-2.38 6.12-6.33c2.76-3.63 4.65-7.25 4.65-7.25s.46-3.59.43-7.31c-.04-3.74-.58-7.36-.58-7.36zm1.25-2 .05 14.96s3.92-3.85 6.44-7.18c1.93-2.54 2.64-5.16 2.64-5.16s1-3.67 1-7.25c0-2.84-1.75-4.87-1.75-4.87s-.75 1.98-2.65 4.13c-2.26 2.56-5.73 5.37-5.73 5.37z' fill='url(#c)'/>" \
...
#define FILE_AUDIO_2_SVG_DATA \
  ...
  "</linearGradient>" \
  "<path d='m2.62 30.87s8.33 5.39 16.38 11c8.44 5.88 16.75 10.88 16.75 10.88l22.37-26.38s-12.68-5.67-22.75-11c-5.19-2.75-9.37-6-9.37-6l-23.38 21.5z' fill='url(#c)'/>" \
...
#define FILE_DEVICE_SVG_DATA \
  ...
  "</linearGradient>" \
  "<path d='m2.62 30.87s8.33 5.39 16.38 11c8.44 5.88 16.75 10.88 16.75 10.88l22.37-26.38s-12.68-5.67-22.75-11c-5.19-2.75-9.37-6-9.37-6l-23.38 21.5z' fill='url(#f)'/>" \
  ...
  "</linearGradient>" \
  "<path transform='matrix(.8902 0 0 .8902 -1.9706 -5.2808)' d='m23 20-14 12 14 7 3-2 15 8m-15-24-7 6 11 7-1 1 14 8m-14-20-11 10 4 2 10-10m4 2-3 3 2 4-3 4 3 2 5-6 8 4' fill='none' stroke='url(#d)' stroke-width='2'/>" \
...
#define FILE_FONT_SVG_DATA \
  ...
  "<stop stop-color='#b3b8ff' offset='1'/>" \
  "</linearGradient>" \
  "<path d='m2.62 30.87s8.33 5.39 16.38 11c8.44 5.88 16.75 10.88 16.75 10.88l22.37-26.38s-12.68-5.67-22.75-11c-5.19-2.75-9.37-6-9.37-6l-23.38 21.5z' fill='url(#b)'/>" \
...
#define FILE_GENERIC_SVG_DATA \
  ...
  "<stop stop-color='#b3b8ff' offset='1'/>" \
  "</linearGradient>" \
  "<path d='m2.62 30.87s8.33 5.39 16.38 11c8.44 5.88 16.75 10.88 16.75 10.88l22.37-26.38s-12.68-5.67-22.75-11c-5.19-2.75-9.37-6-9.37-6l-23.38 21.5z' fill='url(#a)'/>" \
  "</svg>" \
  /**/

#define FILE_IMAGE_3_SVG_DATA \
  "<svg width='64' height='64' color-interpolation='linearRGB' version='1.1' xmlns='http://www.w3.org/2000/svg'>" \
  "<path d='m27 57 2 2 3.13-3.17 4.87 3.17 8.39-11.46 18.61-9.54-5-3 2 2-25 12-9 8zm31-23 4-3-4-2-3 3 3 2z' fill='#010101' fill-opacity='.5725'/>" \
  "<path d='m6.25 30s5.62 6 10.62 12.5 9.38 13.25 9.38 13.25l32.87-18.88-27.12-21.87-25.75 15z' fill='none' stroke='#010101' stroke-width='4'/>" \
  "<radialGradient id='c' cx='0' cy='0' r='64' gradientTransform='matrix(.5714 0 0 .3333 26 35)' gradientUnits='userSpaceOnUse'>" \
...
#define FILE_PDF_SVG_DATA \
  ...
  "</linearGradient>" \
  "<path d='m2.62 30.87s8.33 5.39 16.38 11c8.44 5.88 16.75 10.88 16.75 10.88l22.37-26.38s-12.68-5.67-22.75-11c-5.19-2.75-9.37-6-9.37-6l-23.38 21.5z' fill='url(#d)'/>" \
...
#define FILE_PIPE_SVG_DATA \
  ...
  "</radialGradient>" \
  "<path transform='matrix(.7272 0 0 1.625 9 23.25)' d='m33 6c6.15 0 11 1.74 11 4 0 2.23-4.85 4-11 4-6.17 0-11-1.77-11-4 0-2.26 4.83-4 11-4zm-11 0h22v4h-22v-4z' fill='url(#a)'/>" \
  ...
  "<path transform='translate(0 19)' d='m33 6c6.15 0 11 1.74 11 4 0 2.23-4.85 4-11 4-6.17 0-11-1.77-11-4 0-2.26 4.83-4 11-4zm-11 0h22v4h-22v-4z' fill='url(#a)'/>" \
...
#define FOLDER_GENERIC_SVG_DATA \
  "<svg width='64' height='64' color-interpolation='linearRGB' version='1.1' xmlns='http://www.w3.org/2000/svg'>" \
...
#define OVERLAY_PADLOCK_SVG_DATA \
  "<svg width='64' height='64' color-interpolation='linearRGB' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>" \
  "<defs>" \
